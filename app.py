...
def confirm_buy(pid):
    ...
    try:
        ...
        prod_map={"A1":(20000,16,3000),"A2":(100000,15,9000),"M1":(50000,30,10000),"M2":(100000,30,20000),"M3":(250000,30,50000),"M4":(500000,30,100000),"M5":(1000000,30,200000),"M6":(2000000,30,400000),"M7":(5000000,30,1000000),"L1":(500000,30,110000),"L2":(1000000,30,220000),"L3":(2000000,30,440000),"GS1":(600000,30,132000),"GS2":(1200000,30,264000),"GS3":(2500000,30,550000),"J1":(800000,30,176000),"J2":(1500000,30,330000),"J3":(3000000,30,660000),"K1":(1000000,30,250000),"K2":(5000000,30,1250000),"K3":(10000000,30,2500000),"K4":(50000000,30,12500000)}
        pid=pid.strip().upper()
 if pid not in prod_map:
 return f"Invalid product {pid}",400
 amount,duration_days,daily_return=prod_map[pid]
