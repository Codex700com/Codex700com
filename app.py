...
def checkin_page():
    ...
    .banner{{margin:10px;border-radius:18px;padding:20px;background:linear-gradient(135deg,#0a2a9a,#000000);border:1px solid 55;position:relative;overflow:hidden}}
