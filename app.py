...
S="<meta name='viewport' content='width=device-width,initial-scale=1'><style>*{box-sizing:border-box}body{background:#0b1220;color:#eef2ff;font-family:Inter,system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif;margin:0;padding-bottom:90px;-webkit-font-smoothing:antialiased}a{color:inherit;text-decoration:none}.card{background:linear-gradient(180deg,#111c33,#0b1220);border:1px solid #1e293b;border-radius:16px;padding:18px;margin:14px;box-shadow:0 10px 30px rgba(0,0,0,.35)}.btn{background:linear-gradient(135deg,#fbbf24,#f59e0b);color:#111;font-weight:800;border:0;padding:13px 18px;border-radius:12px;display:inline-block;letter-spacing:.3px}.logo{font-weight:900;font-size:22px;letter-spacing:1.5px;background:linear-gradient(135deg,#fde68a,#f59e0b);-webkit-background-clip:text;background-clip:text;color:transparent}input{width:100%;padding:13px 14px;margin:8px 0;background:#0f172a;border:1px solid #334155;border-radius:12px;color:#fff;font-size:15px;outline:none}input:focus{border-color:#f59e0b;box-shadow:0 0 0 3px rgba(245,158,11,.18)}.nav{position:fixed;bottom:0;left:0;right:0;background:rgba(11,18,32,.96);backdrop-filter:blur(10px);display:flex;justify-content:space-around;padding:10px 6px;border-top:1px solid #1e293b;font-size:11px;z-index:50}.red{color:#f87171}.gold{color:#fbbf24}h2{letter-spacing:.4px}</style>"
