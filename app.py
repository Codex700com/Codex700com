...
def home():
 ...
 for nm,lk,ic in acts: h+="<a href='"+lk+"'><div class=gbox style='"+('background:#0aa5ff;color:#fff;' if nm=='Deposit' else 'background:#ff6b2f;color:#fff;' if nm=='Withdrawal' else '')+"'>"+ic+"<br>"+nm+"</div></a>"
...
def menu():
 ...
 try:
  ...
  if (_me and _me["is_admin"]) or str(_u)=="1": ls.insert(0,("👑 Admin","/admin"))
 except: pass
